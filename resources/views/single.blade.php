...
<div class="content-wrapper">
    ...
    <div class="stunning-header stunning-header-bg-lightviolet">
        <div class="stunning-header-content">
            <h1 class="stunning-header-title">{{$product->name}}</h1>
        </div>
    </div>
            ...
            <main class="main">
                <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post-additional-info">
                                ...
                                {{-- <span class="category">
                                    ...
                                    <a href="{{route('category.page' , ['id' => $post->category->id])}}">{{$post->category->name}}</a>
                    ...
                    <div class="pagination-arrow">
                        ...
                        @if ($prev)
                            <a href="{{route('single.product', ['slug' => $prev->slug])}}" class="btn-prev-wrap">
                                <svg class="btn-prev">
                        ...
                        @if ($next)
                            <a href="{{route('single.product', ['slug' => $next->slug])}}" class="btn-next-wrap">
                                <div class="btn-content">
